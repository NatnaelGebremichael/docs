...
import { $ as $$CardGrid, a as $$Card } from './Code_D_CQ-K6r.mjs';
import 'clsx';
...
const frontmatter = {
  ...
  "hero": {
    ...
    "actions": [{
      "text": "Start Here",
      "link": "/inventory-managment/start-here/",
      "icon": "right-arrow"
    }, {
...
const file = "C:/Personal projects/docs/src/content/docs/index.mdx";
...
Content.moduleId = "C:/Personal projects/docs/src/content/docs/index.mdx";
