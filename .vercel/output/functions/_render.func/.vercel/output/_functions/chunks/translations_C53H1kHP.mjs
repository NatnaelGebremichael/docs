...
import { _ as removeBase, i as isRemotePath, $ as VALID_INPUT_FORMATS, A as AstroError, a0 as UnknownContentCollectionError, B as prependForwardSlash, f as AstroUserError } from './astro/assets-service_BFMv9yxL.mjs';
import { a as createComponent, E as renderUniqueStylesheet, G as renderScriptElement, H as createHeadAndContent, r as renderTemplate, b as renderComponent, u as unescapeHTML } from './astro/server_B6NmzAU1.mjs';
import 'kleur/colors';
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_CjqcLFZA.mjs'),"/src/content/docs/inventory-managment/Reference/example.md": () => import('./example_1Em_w-4r.mjs'),"/src/content/docs/inventory-managment/aws-guide.mdx": () => import('./aws-guide_DvyGjAhI.mjs'),"/src/content/docs/inventory-managment/db-schema.mdx": () => import('./db-schema_uhAfbiuB.mjs'),"/src/content/docs/inventory-managment/seeding.mdx": () => import('./seeding_qF_jU_z2.mjs'),"/src/content/docs/inventory-managment/start-here.mdx": () => import('./start-here_Bx4fT_E_.mjs'),"/src/content/docs/inventory-managment/trouble-shooting.mdx": () => import('./trouble-shooting_DATtDF18.mjs')});
...
let lookupMap = {};
lookupMap = {"docs":{"type":"content","entries":{"index":"/src/content/docs/index.mdx","inventory-managment/aws-guide":"/src/content/docs/inventory-managment/aws-guide.mdx","inventory-managment/start-here":"/src/content/docs/inventory-managment/start-here.mdx","inventory-managment/db-schema":"/src/content/docs/inventory-managment/db-schema.mdx","inventory-managment/seeding":"/src/content/docs/inventory-managment/seeding.mdx","inventory-managment/trouble-shooting":"/src/content/docs/inventory-managment/trouble-shooting.mdx","inventory-managment/reference/example":"/src/content/docs/inventory-managment/Reference/example.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/index.mdx": () => import('./index_DLTtHCwg.mjs'),"/src/content/docs/inventory-managment/Reference/example.md": () => import('./example_uIHTIed3.mjs'),"/src/content/docs/inventory-managment/aws-guide.mdx": () => import('./aws-guide_bd6dmTnm.mjs'),"/src/content/docs/inventory-managment/db-schema.mdx": () => import('./db-schema_2gTGupSG.mjs'),"/src/content/docs/inventory-managment/seeding.mdx": () => import('./seeding_DPpe9EiL.mjs'),"/src/content/docs/inventory-managment/start-here.mdx": () => import('./start-here_BmH3x6Is.mjs'),"/src/content/docs/inventory-managment/trouble-shooting.mdx": () => import('./trouble-shooting_DC5peDpH.mjs')});
